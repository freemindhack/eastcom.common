...
public class Reflections {
	...
	public static void setter(Object obj, String fieldName, Object args) {
		if ((obj == null) || (args == null))
			return;

		if (obj instanceof Class) {
			setter((Class<?>) obj, obj, fieldName, args, args.getClass());
		} else
			setter(obj.getClass(), obj, fieldName, args, args.getClass());
	}

	public static void setter(Object obj, Field field, Object args) {
		try {
			field.setAccessible(true);
			field.set(obj, args);
	...
	public static void setter(Class<?> cls, Object obj, String fieldName, Object args, Class<?> argsType) {
		Field field = null;
		try {
			field = cls.getDeclaredField(fieldName);

			if (!(judTypeClass(argsType, field.getType())))
				args = convert2(args, field.getType());

			field = cls.getDeclaredField(fieldName);
			String mName = field.getName();
			mName = "get"
					+ mName.replaceFirst(new StringBuilder(String.valueOf(mName.charAt(0))).toString(),
	...
	public static Object convert(Object value, Class<?> toClass) {
		...
		// temp = dateformat.format((Date) value);
